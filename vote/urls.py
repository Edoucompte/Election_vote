...
urlpatterns = [
    ...
    path('elections/<int:election_id>/candidates/', CandidatesListView.as_view(), name='Approuved candidates list'),
    # path('elections/<int:election_id>/resultats/', CandidatesListView.as_view(), name='Elections results'),
